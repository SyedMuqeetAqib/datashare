...
$sen = "abcmp3xyzabcbac.mp3";
$start = strlen($sen);
$end = strrpos($sen,".mp3");
echo $start;
echo $end;
echo $start-$end;
echo "<br><br>First sentence is ".strval($sen)." and the second length is ".strval($start)." cuttout length is ".strval($start - $end)."";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
<header class="text-gray-700 body-font shadow">
      ...
      <div class="lg:w-1/3 sm:w-1/2 p-4">
        <div class="flex relative">
          ...
          <div class="px-8 py-10 relative z-10 w-full border-4 border-gray-800 bg-gray-900 opacity-0 hover:opacity-100">
            <h2 class="tracking-widest text-sm title-font font-medium text-teal-500 mb-1">THE SUBTITLE</h2>
